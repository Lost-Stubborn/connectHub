    ...
    <body>
        ...
        <div class="container">
            ...
            <?php
                   ...
                   $query = "SELECT COUNT(*) FROM post_likes WHERE liked_by = (SELECT user_id FROM user_credentials WHERE username = '" . $_SESSION["username"] . "');";
                   $result = mysqli_query($con, $query);
                   echo "<div class='start'>";
                   echo mysqli_fetch_row($result)[0] . " POSTS LIKED </div>";
                   ...
                   WHERE post.post_id in (SELECT post_id FROM post_likes WHERE liked_by = (SELECT user_id FROM user_credentials WHERE username = '" . $_SESSION["username"] . "'))
